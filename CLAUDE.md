...
**Database** ([src/main/database/](src/main/database/)): `better-sqlite3` at `app.getPath('userData')/pulse.db`. Schema is at **migration v25** ([src/main/database/migrations.ts](src/main/database/migrations.ts)) — check this file first before adding columns. Tables span articles, feeds, categories, tickers/ticker summaries, geo_interests, discovery_suggestions, preferences, reels, hyper_chats, favorite_teams, favorite_athletes.
